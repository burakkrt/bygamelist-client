...
import { IServerCardBackgroundSvgProps } from './types'

function ServerCardBackgroundSvg({ status = false }: IServerCardBackgroundSvgProps) {
  return (
    <div className={classNames('server-card-background-svg', { online: status })}>
      <div className="server-card-background-svg-content">
        <svg
        ...
        >
          <path
            className="server-card-background-svg-content-path"
        ...
        <div className="server-card-background-svg-content-state-color" />
      </div>
    </div>
  )
}

export default ServerCardBackgroundSvg
